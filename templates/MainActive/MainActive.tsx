...
export class MainActive extends React.Component<{}> {
    state = {
        whatEdit: false,
        whomEdit: false,
        whenEdit: false,
    ...
    public render() {
        ...
        return (
            <Page
                ...
                isPlaying
            >
                <SectionWrapper title='Когда' isActive isEdit={whenEdit} onChangeState={this.toggleWhenState}>
                    {
                        whenEdit ? (
                            <>
                        ...
                        : (
                            <>
                                <Row title='Период активности'>
                                    Триггер активен на протяжении всей кампании: 25 авг 2018 – 1 янв 2019
                                </Row>
                                <Row title='Инициатор события'>
                                    Потребители из фильтра&nbsp;
                                    <Button color='gray' hasUnderline size='xs'>Условия фильтрации</Button>
                                </Row>
                ...
                <SectionWrapper isActive title='Кому' isEdit={whomEdit} onChangeState={this.toggleWhomState}>
                    {whomEdit ? (
                        <>
                        ...
                        <>
                            <Row title='Применять к потребителю'>Периодически: Максимум один раз за календарный месяц</Row>
                            <Row title='Число срабатываний'>Ограничить 5 разами или меньше</Row>
                ...
                <SectionWrapper title='Что' isActive isEdit={whatEdit} onChangeState={this.toggleWhatState}>
                    {whatEdit ? (
                        <>
                            ...
                            <Row isEdit isSelect title='Действие 3' isAction isRemovable>
                                <Select
                                    placeholder='Выберите действие'
                                    defaultValue='Отправить Email-рассылку'
                                    items={[
                        ...
                        <>
                            ...
                            <Row title='Действие 3'>
                                ...
                                <a href='#'>Напоминание о необходимости подтвердить регистрацию</a>
                            </Row>
                        </>
                    )}
                </SectionWrapper>
